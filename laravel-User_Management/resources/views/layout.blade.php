...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
    <a class="navbar-brand d-flex align-items-center fw-500" href="users.html"><img alt="logo" class="d-inline-block align-top mr-2" src="img/logo.png"> @yield('header-title')</a> <button aria-controls="navbarColor02" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler" data-target="#navbarColor02" data-toggle="collapse" type="button"><span class="navbar-toggler-icon"></span></button>
...
<footer class="page-footer" role="contentinfo">
    ...
    <div>
        <ul class="list-table m-0">
            <li><a href="/" class="text-secondary fw-700">Домой</a></li>
            <li class="pl-3"><a href="#" class="text-secondary fw-700">О Нас</a></li>
        </ul>
    </div>
</footer>
