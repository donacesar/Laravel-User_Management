                ...
                <div class="d-flex align-items-center container p-0">
                    <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center">
                            ...
                            <span class="page-logo-text mr-1">Регистрация</span>
                        </a>
                    </div>
                            ...
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                <form action="register" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email_input" name="email" class="form-control" placeholder="Эл. адрес" value="{{old('name')}}" required>
                                        <div class="invalid-feedback">Заполните поле.</div>
                                        <div class="help-block">Эл. адрес будет вашим логином при авторизации</div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="password_input">Пароль <br></label>
                                        <input type="password" id="password_input" name="password" class="form-control" placeholder="" required>
                                        <div class="invalid-feedback">Заполните поле.</div>
                                    </div>
