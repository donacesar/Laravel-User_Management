                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        {{$member->name}}
                                    @if(\Illuminate\Support\Facades\Auth::user()->role === 'admin' or \Illuminate\Support\Facades\Auth::user()->id == $member->user_id)
                                        <i class="fal fas fa-cog fa-fw d-inline-block ml-1 fs-md"></i>
                                        <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="admin/edit/{{$member->id}}">
                                            <i class="fa fa-edit"></i>
                                            Редактировать
                                        </a>
                                        <a class="dropdown-item" href="admin/security/{{$member->id}}">
                                            <i class="fa fa-lock"></i>
                                            Безопасность
                                        </a>
                                        <a class="dropdown-item" href="admin/status/{{$member->id}}">
                                            <i class="fa fa-sun"></i>
                                            Установить статус
                                        </a>
                                        <a class="dropdown-item" href="admin/media/{{$member->id}}">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="admin/delete/{{$member->id}}" class="dropdown-item" onclick="return confirm('are you sure?');">
                                    ...
                                    <span class="text-truncate text-truncate-xl">{{$member->workplace}}</span>
                                </div>
